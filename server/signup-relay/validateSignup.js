/** Shared signup field validation (relay + kiosk) */
...
export function validateSignupFields({ firstName, lastName, email, phone, requireEventId = false, eventId }) {
  const errors = [];
  ...
  if (requireEventId && !eventId) errors.push('Event is required');
